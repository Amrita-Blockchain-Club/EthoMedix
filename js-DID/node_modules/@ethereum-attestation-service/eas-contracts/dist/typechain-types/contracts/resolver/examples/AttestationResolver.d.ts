...
export interface AttestationResolverInterface extends Interface {
    getFunction(nameOrSignature: "attest" | "isPayable" | "multiAttest" | "multiRevoke" | "revoke" | "toBytes32" | "version"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "toBytes32", values: [BytesLike, BigNumberish]): string;
...
export interface AttestationResolver extends BaseContract {
    ...
    getFunction(nameOrSignature: "toBytes32"): TypedContractMethod<[
        data: BytesLike,
        start: BigNumberish
    ], [
        string
