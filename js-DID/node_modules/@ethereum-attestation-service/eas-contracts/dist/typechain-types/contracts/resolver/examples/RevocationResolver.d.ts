...
export interface RevocationResolverInterface extends Interface {
    getFunction(nameOrSignature: "attest" | "isPayable" | "multiAttest" | "multiRevoke" | "revoke" | "setRevocation" | "version"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "setRevocation", values: [boolean]): string;
...
export interface RevocationResolver extends BaseContract {
    ...
    getFunction(nameOrSignature: "setRevocation"): TypedContractMethod<[status: boolean], [void], "nonpayable">;
